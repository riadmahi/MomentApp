...
class PreviewActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_upload.setOnClickListener {
            ...
            if (intent.hasExtra(getString(R.string.video_file))){
                val intentExtra = intent.getStringExtra(getString(R.string.video_file))
    ...
    private fun uploadThumbnail(counter: Int){
        ...
        val file = File(intent.getStringExtra(getString(R.string.video_file)))

        val bm: Bitmap = ThumbnailUtils.createVideoThumbnail(file.absolutePath , MediaStore.Video.Thumbnails.FULL_SCREEN_KIND)
    ...
    private fun setVideo(videoUrl: String){
        ...
        val duration = intent.getStringExtra(getString(R.string.video_duration)).toString()
